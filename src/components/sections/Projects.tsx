            ...
            <Reveal key={project.id} delay={index * 0.06}>
              <TiltCard className="group h-full" maxTilt={6}>
                <article className="glass-card-hover h-full p-6">
                  <div className="mb-4 h-1 w-12 bg-primary transition-all duration-300 group-hover:w-24" />
                  <p className="font-[family-name:var(--font-mono)] text-[10px] font-bold uppercase tracking-[0.18em] text-accent">
                    {project.category}
                  </p>
